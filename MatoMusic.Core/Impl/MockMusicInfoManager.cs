...
{
    public partial class MockMusicInfoManager : IMusicInfoManager
    {
        ...
        public async Task<InfoResult<List<MusicInfo>>> GetMusicInfos()
        {
            ...
            musicInfos = new List<MusicInfo>()
            {
                new MusicInfo()
                {
                    ...
                    AlbumTitle = "Lavender Haze",
                    Artist ="Taylor Swift",
                    AlbumArt = "p1.jpg",
                    IsFavourite = GetIsMyFavouriteContains("Lavender Haze").Result,
                    IsInitFinished = true
                },
                new MusicInfo()
                {
                    ...
                    Artist ="Taylor Swift",
                    AlbumArt = "p2.jpg",
                    IsFavourite = GetIsMyFavouriteContains("Love Story").Result,
                    IsInitFinished = true
                },
                 new MusicInfo()
                {
                    ...
                    Artist ="Taylor Swift",
                    AlbumArt = "p3.jpg",
                    IsFavourite = GetIsMyFavouriteContains("22").Result,
                    IsInitFinished = true
                },
                  new MusicInfo()
                {
                    ...
                    Artist ="Taylor Swift",
                    AlbumArt = "p4.jpg",
                    IsFavourite = GetIsMyFavouriteContains("Sparks Fly").Result,
                    IsInitFinished = true
                },
                   new MusicInfo()
                {
                    ...
                    Artist ="Taylor Swift",
                    AlbumArt = "p5.jpg",
                    IsFavourite = GetIsMyFavouriteContains("Cold As You").Result,
                    IsInitFinished = true
                }
